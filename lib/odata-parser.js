/**
 * Odata-parser copied from
 * https://github.com/RanAwaySuccessfully/node-odata-parser
 *
 * CHANGELOG:
 * - Added support form international characters
 */
/* eslint-disable */
  ...
  const result = {
    ...
    parse: function (input, startRule) {
      ...
      function parse_unreserved () {
        ...
        pos0 = pos
        if (/^[\p{L}\d\-_]/u.test(input.charAt(pos))) {
          result1 = input.charAt(pos)
          pos++
        } else {
          result1 = null
      ...
      function parse_identifierPart () {
        ...
        pos0 = pos
        pos1 = pos
        if (/^[_\p{L}]/u.test(input.charAt(pos))) {
          result0 = input.charAt(pos)
          pos++
        } else {
          result0 = null
