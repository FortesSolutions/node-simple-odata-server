...
async function processBody (body, cfg, req, res) {
  ...
  try {
    await cfg.base64ToBuffer(req.params.collection, update.$set, req)

    await new Promise((resolve, reject) => {
      cfg.executeUpdate(req.params.collection, query, update, req, (err, entity) => {
